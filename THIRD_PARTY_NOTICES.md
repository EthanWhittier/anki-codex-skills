...
- Included path: `local-review-stack/anki-connect/`
...
- Retained notice: `local-review-stack/anki-connect/LICENSE`
...
- Included path: `local-review-stack/anki-mcp-server/`
...
- Retained license: `local-review-stack/anki-mcp-server/LICENSE`
...
Anki is a separate runtime prerequisite. The local compatibility tests use an installed Anki runtime, but this repository does not redistribute the Anki application or its source.
