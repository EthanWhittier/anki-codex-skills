...
export function calculateStreak(
  ...
  let streak = 0;
  // reviewsByDay is produced with Date#toISOString(), so date-only values are
  // UTC calendar days. Keep every comparison in UTC; converting a YYYY-MM-DD
  // value to local midnight shifts it to the previous day west of UTC.
